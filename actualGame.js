...
let player = {
    x: 512, y: 600, width: 32, height: 48, direction: 0, speed: 0, xChange: 0, yChange: 0, colour: "#fcc203", health: 40
};
let enemy1 = {
...
function draw() {
    ...
    if (level == 8) {
        ...
        let newElement = document.createElement("h1")
        element.appendChild(newElement);
        newElement.innerHTML = "Abandon Ship!"
        setTimeout(() => {
            level = 9
        }, 1)
    }
